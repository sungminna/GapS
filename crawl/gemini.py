...
async def scrape_gemini_pricing():
    async with async_playwright() as p:
        ...
        await page.goto("https://ai.google.dev/gemini-api/docs/pricing", timeout=60000)
        ...
        print(f"스크래핑 완료! 데이터가 'gemini_pricing_data.json'과 CSV 파일들로 저장되었습니다.")
        return 0

if __name__ == "__main__":
    asyncio.run(scrape_gemini_pricing())
